export const en = {
  ...
  // Seed confirm dialog
  seed_confirm_title: "Import starter exercises?",
  seed_confirm_message: "No exercises are registered. Would you like to import the starter exercise catalog?",
  seed_confirm_yes: "Import",
  seed_confirm_no: "Not now",
} as const;
