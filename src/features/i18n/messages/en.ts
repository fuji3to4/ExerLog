export const en = {
  ...
  self_care_description: "Track wellness, body metrics, and small self care wins for this day.",
  self_care_loading_heading: "Loading self care log...",
  self_care_loading_text: "Checking your saved wellness, metrics, and self care entries for this day.",
  self_care_wellness_heading: "Wellness",
  self_care_wellness_text: "Rate how your body and mind feel today.",
  self_care_physical_score_label: "Physical score",
  self_care_mental_score_label: "Mental score",
  self_care_metrics_heading: "Body metrics",
  self_care_metrics_text: "Save any measurements you want to keep for the day.",
  self_care_height_label: "Height",
  self_care_height_unit: "cm",
  self_care_weight_label: "Weight",
  self_care_weight_unit: "kg",
  self_care_body_fat_label: "Body fat",
  self_care_body_fat_unit: "%",
  self_care_log_heading: "Self care log",
  self_care_log_text: "Record the small actions you completed or want to remember.",
  self_care_done_label: "Done",
  self_care_count_label: "Count",
  self_care_minutes_label: "Minutes",
  self_care_note_label: "Note",
  self_care_note_placeholder: "Add a short note for this item.",
  self_care_save_button: "Save self care",
