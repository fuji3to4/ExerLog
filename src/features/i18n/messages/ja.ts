export const ja = {
  ...
  self_care_condition_heading: "体調",
  ...
  // Seed confirm dialog
  seed_confirm_title: "初期データをインポートしますか？",
  seed_confirm_message: "エクササイズが登録されていません。あらかじめ用意された初期データをインポートしますか？",
  seed_confirm_yes: "インポートする",
  seed_confirm_no: "しない",
} as const;
