export const ja = {
  ...
  library_subheading: "全エクササイズカタログを閲覧し、動画と簡単な記録ツールが必要な場合は詳細ページを開きましょう。",
  library_filters_heading: "エクササイズを探す",
  library_filters_subheading: "簡単な検索を使うか、1つまたは2つのフィルターでリストを絞り込みましょう。",
  library_search_label: "エクササイズを検索",
  library_search_placeholder: "タイトルまたは説明で検索",
  ...
  self_care_description: "この日の体調、身体指標、小さなセルフケアをまとめて記録しましょう。",
  self_care_loading_heading: "セルフケアの記録を読み込み中...",
  self_care_loading_text: "この日に保存した体調、指標、セルフケア記録を確認しています。",
  self_care_wellness_heading: "ウェルネス",
  self_care_wellness_text: "今日の体と心の状態を記録しましょう。",
  self_care_physical_score_label: "身体スコア",
  self_care_mental_score_label: "心のスコア",
  self_care_metrics_heading: "身体指標",
  self_care_metrics_text: "この日に残したい測定値を保存しましょう。",
  self_care_height_label: "身長",
  self_care_height_unit: "cm",
  self_care_weight_label: "体重",
  self_care_weight_unit: "kg",
  self_care_body_fat_label: "体脂肪率",
  self_care_body_fat_unit: "%",
  self_care_log_heading: "セルフケア記録",
  self_care_log_text: "できたことや覚えておきたいことを項目ごとに残しましょう。",
  self_care_done_label: "完了",
  self_care_count_label: "回数",
  self_care_minutes_label: "分",
  self_care_note_label: "メモ",
  self_care_note_placeholder: "この項目のメモを追加してください。",
  self_care_save_button: "セルフケアを保存",
  ...
  // Body area values
  body_area_upper_body: "上半身",
  body_area_lower_body: "下半身",
  body_area_full_body: "全身",
  body_area_all: "すべての体の部位",

  // Purpose values
  purpose_warmup: "ウォームアップ",
  purpose_mobility: "モビリティ",
  purpose_strength: "筋力",
  purpose_recovery: "回復",
  purpose_endurance: "持久力",
  purpose_all: "すべての目的",
